...
from yolov5_ros.utils.general import LOGGER, colorstr, cv2
from yolov5_ros.utils.loggers.clearml.clearml_utils import ClearmlLogger
from yolov5_ros.utils.loggers.wandb.wandb_utils import WandbLogger
from yolov5_ros.utils.plots import plot_images, plot_labels, plot_results
...
try:
    if RANK in {0, -1}:
        ...
        from yolov5_ros.utils.loggers.comet import CometLogger
...
class GenericLogger:
    """YOLOv5 General purpose logger for non-task specific logging Usage: from yolov5_ros.utils.loggers import GenericLogger;
