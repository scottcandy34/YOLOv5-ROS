...
colors = Colors()  # create instance for 'from yolov5_ros.utils.plots import colors'
...
def plot_val_txt():
    ...
    Example: from yolov5_ros.utils.plots import *; plot_val()
    """
...
def plot_targets_txt():
    ...
    Example: from yolov5_ros.utils.plots import *; plot_targets_txt()
    """
...
def plot_val_study(file="", dir="", x=None):
    ...
    Example: from yolov5_ros.utils.plots import *; plot_val_study()
    """
...
def plot_evolve(evolve_csv="path/to/evolve.csv"):
    ...
    Example: from yolov5_ros.utils.plots import *; plot_evolve()
    """
...
def plot_results(file="path/to/results.csv", dir=""):
    ...
    Example: from yolov5_ros.utils.plots import *; plot_results('path/to/results.csv')
    """
    save_dir = Path(file).parent if file else Path(dir)
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=""):
    ...
    Example: from yolov5_ros.utils.plots import *; profile_idetection()
    """
