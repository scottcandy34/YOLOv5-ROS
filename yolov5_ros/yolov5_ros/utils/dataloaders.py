...
def extract_boxes(path=DATASETS_DIR / "coco128"):
    ...
    Example: from yolov5_ros.utils.dataloaders import *; extract_boxes()
    """
...
def autosplit(path=DATASETS_DIR / "coco128/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    """Autosplit a dataset into train/val/test splits and save path/autosplit_*.txt files Usage: from yolov5_ros.utils.dataloaders
    import *; autosplit().
...
class HUBDatasetStats:
    ...
    Args:
        ...
        autodownload: Attempt to download dataset if not found locally
            ...
            Usage
        from yolov5_ros.utils.dataloaders import HUBDatasetStats
