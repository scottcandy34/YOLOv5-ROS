...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yolov5_ros.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        # PaddlePaddle
            ...
            from yolov5_ros.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from yolov5_ros.utils.downloads import is_url
