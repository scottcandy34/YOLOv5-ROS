...
from yolov5_ros.utils.segment.general import masks2segments, process_mask, process_mask_native
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # pred = yolov5_ros.utils.general.apply_classifier(pred, classifier_model, im, im0s)
