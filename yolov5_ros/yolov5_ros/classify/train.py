...
from yolov5_ros.classify import val as validate
from yolov5_ros.models.experimental import attempt_load
from yolov5_ros.models.yolo import ClassificationModel, DetectionModel
from yolov5_ros.utils.dataloaders import create_classification_dataloader
...
from yolov5_ros.utils.plots import imshow_cls
...
def run(**kwargs):
    ...
    Example: from yolov5 import yolov5_ros.classify; classify.train.run(data=mnist, imgsz=320, model='yolov5m')
    """
    opt = parse_opt(True)
